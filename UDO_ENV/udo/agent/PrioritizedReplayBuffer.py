...
class PrioritizedReplayBuffer:
    ...
    def sample(self, batch_size):
        ...
        return sample_idxs, weights, tree_idxs
        return dict(obs1=self.state[sample_idxs],
                    obs2=self.next_state[sample_idxs],
                    acts=self.action[sample_idxs],
                    rews=self.reward[sample_idxs],
                    done=self.done[sample_idxs],
                    idxs=sample_idxs), weights, tree_idxs
